...
});</code></pre><p>這樣我們就能依星等分類做隨機選題且不會選到已經完成的題目了(*^▽^*)<br>但... (○´･д･)ﾉ我們目前都沒用到Fomantic UI耶</p><p>沒錯接下來要做視覺畫界面♪(^∇^*)<br>但礙於篇幅今天先到這，感謝你的閱讀O(∩_∩)O</p>`,20),p={__name:"CPEExample",setup(a){return o.registerLanguage("js",t),e(()=>{o.highlightAll()}),(l,s)=>n}};export{p as default};
